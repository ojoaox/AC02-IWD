...
const Header = () => {
  ...
  return (
    <header className='fixed top-0 left-0 w-full h-20 flex items-center z-40 bg-gradient-to-b from-zinc-900 to-zinc-900/0 max-md:px-1'>
    <div className='max-w-[1150px] w-full mx-auto px-4 flex justify-between items-center md:px-6'>
      <h1>
        <a href='/'>
          <img src='./public/logo/logo.svg' alt='logo' width={32} height={32} />
        </a>
      </h1>
